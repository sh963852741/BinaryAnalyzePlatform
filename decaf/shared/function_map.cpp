...
// Added by Lei
// Get start and end address of a module
int funcmap_get_pc_range_by_pc(target_ulong pc, target_ulong cr3, target_ulong * pc_start, target_ulong * pc_end)
{
	target_ulong base;
	...
	*pc_start = mod->pc_start;
	*pc_end = mod->pc_end;
	return 0;
}

int funcmap_get_pc_range_by_name(char * mod_name, target_ulong cr3, target_ulong * pc_start, target_ulong * pc_end)
{
        target_ulong base;
