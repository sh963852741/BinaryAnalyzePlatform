...
// Added by Lei
// Set information for an expected application
extern target_ulong get_expected_cr3();         // for target-cpu upon tcg translation
extern void set_expected_cr3(target_ulong cr3); // for plugins

extern int get_expected_mod_name(char * mod_name);         // for target-cpu upon tcg translation
extern void set_expected_mod_name(char * mod_name); // for plugins

extern FILE * get_tcg_log_file();         // for target-cpu upon tcg translation
extern void set_tcg_log_file(bool set_file); // for plugins

// get vma range of expected module
extern void get_expected_pc_range(target_ulong* pc_start, target_ulong * pc_end);
extern void set_expected_pc_range(target_ulong pc_start, target_ulong pc_end);
