...
#error unsupported target CPU
    ...
    defined(TARGET_MICROBLAZE) || defined(TARGET_LM32) || defined(TARGET_UNICORE32)
		...
		if(tb->pc < 150000000)
		{
			//printf("tb_find_fast start\n");
			//fflush(stdout);
		}
		//printf("tb_find_fast end\n");
		//fflush(stdout);
		...
		// Added by Lei
		// Wrong operation!! Instrument tb at tranlation
		// only supprt X86 currently
		#if 0
		#if defined(TARGET_I386) 
		{
		    //if(DECAF_is_BlockBeginCallback_needed(tb->pc))
		    {
			//printf("cpu_exec(), BlockBegin is needed \n");
			invoke_block_start_cb_translate(env, tb);
		    }
		} 
		#endif
		#endif
